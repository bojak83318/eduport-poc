# Agent 34: QA Engineer - User Guide
...
A comprehensive user guide helps teachers quickly get started with EduPort. The guide should include step-by-step instructions, FAQ, and troubleshooting.

---

## Task

Create a user guide with FAQ at `/GUIDE.md`.
...
1. ✅ Guide created at `/GUIDE.md`
2. ✅ Getting Started section (5 steps)
3. ✅ Uploading to Moodle section with screenshots reference
4. ✅ FAQ with 10+ common questions
5. ✅ Troubleshooting section
6. ✅ Markdown well-formatted
